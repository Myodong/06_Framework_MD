...
<body>
        ...
        <section class="board-detail">  
            ...
            <div class="board-header">
                <div class="board-writer">
                    ...
                    <!-- 프로필 이미지가 있을경우 -->
                    <c:if test="${not board.profileImage}">
                ...
                <c:if test ="${not empty thumbnail}">                
                    ...
                    <div class="img-box">
                        <div class="boardImg thumbnail">
                            ...
                            <a href="${thumbnail.imagePath}${thumbnail.imageReName}" download="${thumbnail.imageOriginal}">다운로드</a>         
                        </div>
                    </div>
                </c:if>

                <!-- 업로드 이미지가 있는 경우 -->
                <c:if test="${empty thumbnail}"> <%--  썸네일x--%>
                    <c:set var="start" value="0"/>
                </c:if>

                <c:if test="${not empty thumbnail}"> <%--  썸네일0--%>
                    ...
                    <div class="img-box">
                        <c:forEach var="i" begin="${start}" end="${fn:length(board.imageList) - 1}">
                            <div class="boardImg">
                                ...
                                <a href="${board.imageList[i].imagePath}${board.imageList[i].imageReName}" download="${board.imageList[i].imageOriginal}">다운로드</a>                
                            </div>
                        </c:forEach>
            ...
            <div class="board-btn-area">
                ...
                <c:if test="${loginMember.memberNo == boad.memberNo }">
    ...
    <script>
        ...
        // *** JS에서 EL/JSTL 사용 시 양쪽에 "" 또는 '' 를 붙이는 것을 권장 ***
