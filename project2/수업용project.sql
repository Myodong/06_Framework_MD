...
CREATE SEQUENCE SEQ_IMG_NO NOCACHE; --게시글이미지 번호
...
VALUES (SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr','pass02!',
	'이유저','01022222222','04540,,서울시 중구 남대문로 120,,3층',
	DEFAULT,DEFAULT,DEFAULT,DEFAULT
);
--DML쓰고 나면 까먹지말구!!
COMMIT;
...
MEMBER_TEL = '01222223333',
MEMBER_ADDRESS = '12345,,냥,,냥냥'
WHERE MEMBER_NO = 4; 
				--> 로그인한 회원의 번호
...
SELECT COUNT(*)
FROM "MEMBER"
WHERE MEMBER_NICKNAME  = '묘동'
AND MEMBER_DEL_FL  = 'N'

-- 이메일이 일치하는 회원 정보 조회
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_ADDRESS, MEMBER_DEL_FL,TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일"') AS ENROLL_DATE
FROM "MEMBER"
...
BEGIN
	FOR I IN 1..2000 LOOP
		...
		VALUES(SEQ_BOARD_NO.NEXTVAL,
			 	...
			 	DEFAULT,DEFAULT,DEFAULT,DEFAULT, 11,
...
VALUES(SEQ_IMG_NO.NEXTVAL,'/resources/imags/board','20221116105843_00001.gif','1.gif', 0, 2006);

INSERT  INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL,'/resources/imags/board','20221116105843_00002.gif','2.gif', 0, 1999);

INSERT  INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL,'/resources/imags/board','20221116105843_00003.gif','3.gif', 0, 1985);

INSERT  INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL,'/resources/imags/board','20221116105843_00004.gif','4.gif', 0, 1984);
...
INSERT INTO BOARD_LIKE VALUES(2006,11);
INSERT INTO BOARD_LIKE VALUES(1984,11);
...
-- 특정게시글 목록 조회
-- 게시글번호, 제목, 작성자닉네임, 조회수, 작성일+댓글수, 좋아요수, 썸네일
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, READ_COUNT,
   ...
   END B_CREATE_DATE,
	...
	WHERE C.BOARD_NO = B.BOARD_NO) COMMENT_CONTENT ,
...
'20221116105843_00002.gif', '2.gif', 1 , 2006);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00003.gif', '3.gif', 2 , 2006);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20221116105843_00004.gif', '4.gif', 3 , 2006);

COMMIT;
-- 특정 게시글 댓글 모두 조회(어려움)
SELECT COMMENT_NO, COMMENT_CONTENT,TO_CHAR(C_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') C_CREATE_DATE,
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 2006, 11, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 2006, 12, null);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 2006, 2, 2004);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 2006, 3, 2004);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 2006, 12, 2004);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 2006, 11, 2005);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 2006, 13, 2005);
COMMIT;
...
START WITH PARENT_NO IS NULL --PARENT_NO가 NULL 경우 최상위 부모다
