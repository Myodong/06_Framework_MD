...
public class MyPageController {
	...
	public String profile() {
		...
		// "/WEB_INF/views/member/myPage-profil.jsp"
		// servlet-context.xml 파일에 
		// <beans:property name="prefix" value="/WEB-INF/views/" />
		// <beans:property name="suffix" value=".jsp" />	
		// 의해 앞에 /WEB-INF/views/  뒤에 .jsp 빼고 작성
	...
	// MultipartFile
	// - MultipartResolver에 의해서 반환 된
	//	input type ="file"의 값을 저장한 객체
	
	// - 제공 메서드
	// 1) getOriginalFilename() : 파일 원본명
	// 2) getSize() : 파일 크기
	// 3) transferTo : 메모리에 임시 저장된 파일을 저장된 경로에 저장
